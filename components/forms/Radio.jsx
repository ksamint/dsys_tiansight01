...
export function Radio({ label, description, name, value, checked, onChange, disabled = false, id, ...rest }) {
  ...
  return React.createElement("label", {
    ...
    React.createElement("input", {
      type: "radio", id: uid, name, value, checked, onChange, disabled,
      style: { width: 15, height: 15, marginTop: 3, accentColor: "var(--bronze-500)", flexShrink: 0 },
      ...rest
    }),
